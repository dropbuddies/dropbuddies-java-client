...
import com.dropbuddies.auth.HttpBasicAuth;
import com.dropbuddies.auth.ApiKeyAuth;
import com.dropbuddies.auth.OAuth;
import com.dropbuddies.auth.OAuth.AccessTokenListener;
import com.dropbuddies.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient(String[] authNames) {
        ...
        for(String authName : authNames) { 
            Interceptor auth;
            if (authName == "jwtToken") { 
                auth = new OAuth(OAuthFlow.accessCode, "https://github.com/login/oauth/authorize", "https://github.com/login/oauth/access_token", "user, dropbuddy, developers");
            } else {
    ...
    public void createDefaultAdapter() {
        ...
        String baseUrl = "http://api.dropbuddies.com/v1";
        if(!baseUrl.endsWith("/"))
        	baseUrl = baseUrl + "/";
