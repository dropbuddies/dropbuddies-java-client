...
import com.dropbuddies.core.client.Promos;
...
public class InlineResponse2006   {
  ...
  @SerializedName("data")
  private List<Promos> data = new ArrayList<Promos>();

  public InlineResponse2006 error(Integer error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2006 data(List<Promos> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2006 addDataItem(Promos dataItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<Promos> getData() {
    return data;
  }

  public void setData(List<Promos> data) {
    this.data = data;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.error, inlineResponse2006.error) &&
